...
\begin{itemize}
\item Pour la méthode $a$, $t_{i1} =2t_1+2t_2+ 2t_3 +t_4 = $ %\SI{840}{min}$.
...
On isole $E_1$. Bilan des puissances internes : les liaisons internes au système considérée sont considérées sans frottement. On a donc : $\mathcal{P}_{\text{int}}\left(E_1\right)=0$.
...
Le diagramme en gain montre alors l'addition d'un gain du second ordre et d'un gain périodique. (***)
\subparagraph{}
